...
// components/pasien/PasienTable.tsx
'use client'
      ...
      <table className="min-w-full text-sm text-left text-gray-700">
        ...
        <tbody>
          {pasienList.map((pasien, index) => (
            <tr key={pasien.id} className="border-t hover:bg-gray-50">
              ...
              <td className="p-4">{pasien.alamat}</td>
              ...
              <td className="p-4 relative">
                <PasienDropdown
                  isOpen={openDropdownId === pasien.id}
                  onToggle={() => toggleDropdown?.(pasien.id)}
